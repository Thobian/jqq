...
public class TEA {
  ...
  //通过TEA算法加密信息
	...
	public static String entea_hexstr(String data, String key) {
		 //return new String(Hex.decodeHex( TEA.encryptByTea(new String (Hex.decodeHex(data.toCharArray())) + new String( Hex.decodeHex(key.toCharArray())))));
		return null;
	}
